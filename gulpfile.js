...
var paths = {
    ...
    views: {
        ...
        files: [mrmedia.app + '/partials/*.html']
    }
};
...
gulp.task('copy:views', function () {
    return gulp.src(mrmedia.app + '/partials/**/*')
        .pipe(gulp.dest(mrmedia.dist + '/partials'));
});

gulp.task('images', function () {
    return gulp.src(mrmedia.app + '/img/**/*')
        // .pipe($.cache($.imagemin({
        //     optimizationLevel: 5,
        //     progressive: true,
        //     interlaced: true
        // })))
        .pipe(gulp.dest(mrmedia.dist + '/img'));
});
...
gulp.task('serve', ['browser-sync'], function () {
    ...
    gulp.watch('{app/index.html,app/js/**/*.js,.tmp/styles/**/*.css}', ['client:dev']);
